...
export const Hero = () => {
  return (
    <div className="w-full relative flex flex-row items-start justify-start gap-[266px] text-left text-[14px] text-gray-200 font-dm-sans">
      ...
      {/* Main Hero Section */}
      <div className="w-[1078px] relative h-[568px] text-center text-[60.84px] text-primary-dark">
        <Image
          className="absolute h-full w-[36.11%] top-[0%] right-[0%] bottom-[0%] left-[63.89%] max-w-full overflow-hidden max-h-full object-cover"
          width={389}
          height={568}
          alt="Hero Right Image"
          src="/assets/Right.png"
        />
        <div className="absolute h-full w-[63.91%] top-[0%] right-[36.09%] bottom-[0%] left-[0%] bg-lightgray flex flex-col items-center justify-start py-36 px-0 box-border gap-[50px] bg-[#d6d7d7]">
          <div className="w-[689px] flex flex-col items-center justify-start gap-[12.7px]">
            ...
            <div className="w-[649px] relative text-[18.59px] leading-[30.42px] text-gray-3 inline-block text-[#828282]">
              Empower your recruiting team. The one-stop platform for all talent
              acquisition of small to large-sized businesses.
            </div>
          </div>

          {/* Align the email input white box correctly within the grey box */}
          <div className="w-[554px] h-[60.8px] relative bg-white rounded-[30px] flex items-center justify-between px-5 py-2">
            ...
            {/* Right-aligned Book a Demo button */}
